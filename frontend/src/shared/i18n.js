export const zh = {
    ...
    loginToChat: '请登录后参与聊天',
    loginToPost: '请登录后发布话题',
    deleteTopic: '删除话题',
    deleteComment: '删除评论',
    editTopic: '编辑话题',
    pin: '置顶',
    ...
    registrationIpLimit: '单IP每日注册限制',
    apiRateLimit: 'API速率限制 (次/分钟)',
    chatInterval: '聊天发言间隔 (秒)',
    leaderboardLimit: '排行榜显示数量',
    securitySettingsHint: '配置安全阈值以防止滥用 (需要重启生效)',
    ...
    maxFileSize: '最大文件大小',
    imageCompression: '启用图片压缩',
    compressImages: '自动压缩上传的图片以减少体积',
    siteInfo: '站点信息',
    siteName: '站点名称',
    siteWelcome: '论坛欢迎语',
    icpNumber: 'ICP备案号',
    ...
    solved: '已解决',
    purchase: '购买',
    purchaseConfirm: '确定要花费 {amount} 积分购买此话题的阅读权限吗？',
    ...
    insufficient_points_bounty: '悬赏积分不足',
    permission_denied: '权限拒绝',
    topic_already_solved: '话题已解决',
    ...
    reason_required: '申请理由不能为空',
    registration_limit_exceeded: '注册限制已超出',
    ...
    update_profile_failed: '更新资料失败',
    passwords_required: '旧密码和新密码不能为空',
...
export const en = {
    ...
    replaceFailed: 'File replace failed',
    ...
    filterPaid: 'Paid Topics',
    filterFree: 'Free Topics',
    filterBounty: 'Bounty Topics',
    ...
    registrationIpLimit: 'Registration IP Limit (Daily)',
    apiRateLimit: 'API Rate Limit (Requests/Min)',
    chatInterval: 'Chat Message Interval (Seconds)',
    leaderboardLimit: 'Leaderboard Limit',
    securitySettingsHint: 'Configure security thresholds to prevent abuse (Restart required)',
    ...
    compressImages: 'Automatically compress uploaded images to reduce size',
    siteInfo: 'Site Info',
    siteName: 'Site Name',
    siteWelcome: 'Forum Welcome Message',
    ...
    solved: 'Solved',
    purchase: 'Purchase',
    purchaseConfirm: 'Purchase access for {amount} points?',
    ...
    insufficient_points_bounty: 'Insufficient points for bounty',
    permission_denied: 'Permission denied',
    topic_already_solved: 'Topic already solved',
    ...
    registration_limit_exceeded: 'Registration limit exceeded',
    ...
    passwords_required: 'Old and new passwords are required',
